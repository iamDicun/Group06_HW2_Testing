...
| `TC_PM_03` | Positive | Xóa sản phẩm khỏi danh sách thành công | Đã có sản phẩm cần xóa | `id: 2` | Click "Xóa" dòng sản phẩm tương ứng | Sản phẩm bị xóa khỏi bảng danh sách | P0 |
