...
- Name: coupons.spec.ts >> FR-09: Discount Coupons Tests >> TC_CP_09 - Apply coupon exceeding max usage per user
...
Expected substring: "Bạn đã sử dụng hết số lần cho phép của mã này"
...
Call log:
  ...
  - waiting for locator('p.text-red-600')
    13 × locator resolved to <p class="mt-2 text-red-600 text-sm">Mã giảm giá không tồn tại hoặc đã bị vô hiệu hóa</p>
