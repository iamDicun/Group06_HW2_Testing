...
- Name: product-mgmt.spec.ts >> FR-15: Product Management CRUD Tests (Web Admin) >> TC_PM_03 - Delete existing product with confirm dialog validation (Detect BUG-FR15-004)
