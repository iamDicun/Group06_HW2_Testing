...
- Name: coupons.spec.ts >> FR-09: Discount Coupons Tests >> TC_CP_11 - Modify total amount field after coupon is applied resets coupon result
...
Locator: locator('text=Tiết kiệm:')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('text=Tiết kiệm:')
