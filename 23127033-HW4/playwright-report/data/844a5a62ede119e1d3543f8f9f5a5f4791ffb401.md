...
- Name: coupons.spec.ts >> FR-09: Discount Coupons Tests >> TC_CP_14 - Validate SAVE10 percentage discount formula at 1,000,000 VND total order (Detect BUG-FR09-002)
...
Expected substring: "100,000"
Received string:    "✅ Áp dụng thành công! Giảm 10%Tiết kiệm: -9,000,000 ₫Thành tiền: 10,000,000 ₫"
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('div.text-green-700')
    13 × locator resolved to <div class="mt-2 text-green-700 text-sm space-y-1">…</div>
       - unexpected value "✅ Áp dụng thành công! Giảm 10%Tiết kiệm: -9,000,000 ₫Thành tiền: 10,000,000 ₫"
