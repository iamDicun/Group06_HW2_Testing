# STT-FORGOT-PW-007 - Forgot Password - Email Form --[Submit invalid or unregistered email]--> Forgot Password - Email Form
...
## Bước thực hiện
Kích hoạt sự kiện **Submit invalid or unregistered email** (điều kiện: email trống, sai định dạng, hoặc chưa đăng ký).

## Kết quả mong đợi
Hệ thống chuyển sang trạng thái **Forgot Password - Email Form**. Hệ thống thực hiện: Hiển thị validation/lỗi và không cho qua bước reset..
