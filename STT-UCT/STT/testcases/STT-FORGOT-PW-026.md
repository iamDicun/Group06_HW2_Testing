# STT-FORGOT-PW-026 - Reset Completed nhận sự kiện KHÔNG hợp lệ Submit invalid or unregistered email
...
- Từ trạng thái **Reset Password Form**, kích hoạt sự kiện **Submit valid OTP and matching strong password** (điều kiện: OTP đúng 6 chữ số; password mạnh tối thiểu 8 ký tự; confirm password khớp) → hệ thống chuyển sang **Reset Completed**.

## Bước thực hiện
Kích hoạt sự kiện **Submit invalid or unregistered email**.

## Kết quả mong đợi
Hệ thống PHẢI từ chối / báo lỗi và giữ nguyên trạng thái **Reset Completed** (không có transition nào định nghĩa cho tổ hợp này — cần xác nhận đây là hành vi mong muốn).
