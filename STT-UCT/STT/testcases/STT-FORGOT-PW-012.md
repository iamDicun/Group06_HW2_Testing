# STT-FORGOT-PW-012 - Reset Completed --[Back to Login]--> Login
...
## Kết quả mong đợi
Hệ thống chuyển sang trạng thái **Login**. Hệ thống thực hiện: Quay lại Login để đăng nhập bằng mật khẩu mới..
