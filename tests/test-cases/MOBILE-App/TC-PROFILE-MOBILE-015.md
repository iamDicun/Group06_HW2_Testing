# TC-PROFILE-MOBILE-015: Cập nhật Địa chỉ giao hàng chứa thẻ HTML hoặc Script để kiểm tra XSS
...
| Field | Value |
|---|---|
| Địa chỉ giao hàng | "<script>alert('XSS')</script>" |

## Test Steps
1. Nhập hoặc dán chuỗi "<script>alert('XSS')</script>" vào ô nhập Địa chỉ giao hàng.
