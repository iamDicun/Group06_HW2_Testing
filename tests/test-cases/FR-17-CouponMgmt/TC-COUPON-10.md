# TC-COUPON-10: Create coupon — Expired at rỗng (EP)
...
3. Để trống trường **expired_at**
4. Click **Tạo mã**

## Expected Result
Trình duyệt chặn submit do thuộc tính `required` trên input expired_at. Hiển thị thông báo "Please fill out this field". Không gọi API.
