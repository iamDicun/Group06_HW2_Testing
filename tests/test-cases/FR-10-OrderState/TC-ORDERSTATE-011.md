# TC-ORDERSTATE-011: Cập nhật trạng thái đơn hàng thành công từ confirmed sang shipping (Domain Testing)
...
## Test Steps
1. Gửi request PUT /api/admin/orders/2/status với body {"status": "shipping"} và token Admin.
2. Kiểm tra phản hồi và CSDL.

## Expected Result
- Mã phản hồi HTTP trả về là 200 OK.
- Trạng thái đơn hàng trong DB được chuyển thành "shipping" thành công.
...
## Notes
- Luồng nghiệp vụ hợp lệ: confirmed -> shipping (do Admin thực hiện).
