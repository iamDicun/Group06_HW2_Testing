# TC-ORDERSTATE-013: Cập nhật trạng thái đơn hàng thành công từ pending sang canceled (bởi Admin) (Domain Testing)
...
## Test Steps
1. Gửi request PUT /api/admin/orders/1/status với body {"status": "canceled"} và token Admin.
...
## Notes
- Luồng nghiệp vụ hợp lệ: pending -> canceled (Admin hủy).
