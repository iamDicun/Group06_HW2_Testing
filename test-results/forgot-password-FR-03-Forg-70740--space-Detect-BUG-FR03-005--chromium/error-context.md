...
- Name: forgot-password.spec.ts >> FR-03: Forgot Password & Reset Tests >> TC_FP_10 - Reset password with standard 8 char strong password without space (Detect BUG-FR03-005)
