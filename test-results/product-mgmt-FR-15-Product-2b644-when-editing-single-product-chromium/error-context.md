...
- Name: product-mgmt.spec.ts >> FR-15: Product Management CRUD Tests (Web Admin) >> TC_PM_12 - Detect SUT bug: Mass update of all product names when editing single product
