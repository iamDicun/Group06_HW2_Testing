...
- Name: coupons.spec.ts >> FR-09: Discount Coupons Tests >> TC_CP_16 - Attempt to apply coupon when user is not logged in / guest user (Detect BUG-FR09-003)
...
Expected substring: "Bạn cần đăng nhập để sử dụng mã giảm giá"
