...
- Name: coupons.spec.ts >> FR-09: Discount Coupons Tests >> TC_CP_02 - Apply valid fixed amount coupon FREESHIP (30,000 VND off)
...
- main:
  ...
  - spinbutton: "200000"
  - text: Mã Giảm Giá
  - textbox "Nhập mã giảm giá...": FREESHIP
  - button "Áp dụng"
  - paragraph: Mã giảm giá không tồn tại hoặc đã bị vô hiệu hóa
  - text: "Tổng thanh toán: 200,000 ₫"
