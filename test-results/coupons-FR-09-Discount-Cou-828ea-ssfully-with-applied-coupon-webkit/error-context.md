...
- Name: coupons.spec.ts >> FR-09: Discount Coupons Tests >> TC_CP_04 - Confirm checkout successfully with applied coupon
...
Locator: getByRole('heading', { name: 'Thanh toán thành công!' })
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('heading', { name: 'Thanh toán thành công!' })
