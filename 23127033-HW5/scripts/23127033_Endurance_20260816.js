// 23127033_Endurance_20260816.js — k6 Endurance / Soak Test Script (10-15 mins)
// Student ID: 23127033
...
const TEST_NAME = __ENV.TEST_NAME || '23127033_Endurance_20260816';
...
export const options = {
  stages: [
    ...
    { duration: '10m', target: 15 }, // Hold sustained load for 10 minutes
...
export default function () {
  ...
  group('06_Transaction_Checkout', function () {
    const payload = JSON.stringify({
      ...
      shipping_address: '123 Endurance St',
    });
...
function textReport(data) {
  ...
  return `\n=== K6 ENDURANCE TEST SUMMARY: ${TEST_NAME} ===\nRequests: ${reqs} (${rps} req/s)\np95 Latency: ${p95} ms\nError Rate: ${failed}%\n=========================================\n`;
}
