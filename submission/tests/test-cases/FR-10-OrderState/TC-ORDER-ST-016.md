# TC-ORDER-ST-016: Chuyển đổi từ Final State canceled -> confirmed

**Kỹ thuật thiết kế**: State Transition Testing
**Tham chiếu test condition**: ST-016
**Endpoint**: PUT /api/admin/orders/{{order_id}}/status

## Mục tiêu
Kiểm tra chuyển đổi trạng thái đơn hàng từ 'canceled' sang 'confirmed' (Invalid)
