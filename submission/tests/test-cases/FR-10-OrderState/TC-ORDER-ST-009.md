# TC-ORDER-ST-009: Chuyển lùi trạng thái shipping -> pending

**Kỹ thuật thiết kế**: State Transition Testing
**Tham chiếu test condition**: ST-009
**Endpoint**: PUT /api/admin/orders/{{order_id}}/status

## Mục tiêu
Kiểm tra chuyển đổi trạng thái đơn hàng từ 'shipping' sang 'pending' (Invalid)
