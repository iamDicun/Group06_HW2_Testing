# TC-ORDER-ST-011: Chuyển đổi từ Final State delivered -> pending

**Kỹ thuật thiết kế**: State Transition Testing
**Tham chiếu test condition**: ST-011
**Endpoint**: PUT /api/admin/orders/{{order_id}}/status

## Mục tiêu
Kiểm tra chuyển đổi trạng thái đơn hàng từ 'delivered' sang 'pending' (Invalid)
