...
Write-Host "   ESHOP K6 PERFORMANCE TEST RUNNER (MSSV: 23127391)" -ForegroundColor Cyan
Write-Host "==========================================================" -ForegroundColor Cyan
...
if ($Scenario -eq "load" -or $Scenario -eq "all") {
    Run-K6Test -ScriptName "23127391_Load_20260815.js" -ReportType "Listener 1: Interactive HTML Dashboard"
}

if ($Scenario -eq "stress" -or $Scenario -eq "all") {
    Run-K6Test -ScriptName "23127391_Stress_20260815.js" -ReportType "Listener 2: Aggregated JSON Metric Export"
}

if ($Scenario -eq "spike" -or $Scenario -eq "all") {
    Run-K6Test -ScriptName "23127391_Spike_20260815.js" -ReportType "Listener 3: Raw Text Console & Metric Log"
}

if ($Scenario -eq "endurance") {
    Run-K6Test -ScriptName "23127391_Endurance_20260815.js" -ReportType "Endurance/Soak Test Summary"
}
