...
## 5. Task 2: Usability Evaluation (Placeholder)

### 5.1 Mục tiêu & Kịch bản nhiệm vụ (Task Scenario)
- **Mục tiêu**: Đánh giá trải nghiệm người dùng thực tế trên luồng mua sắm end-to-end.
- **Kịch bản nhiệm vụ**: *"Tìm kiếm sản phẩm mong muốn, thêm vào giỏ hàng và tiến hành thanh toán kiểm tra lịch sử đơn hàng."*

### 5.2 Danh sách 7 người tham gia (Participant List)

| STT | Họ tên người tham gia | Đối tượng | Thông tin liên hệ (Mã hóa 4 số giữa) |
|---|---|---|---|
| 1 | Người tham gia 1 | Khách hàng tự do | 0912***567 |
| 2 | Người tham gia 2 | Sinh viên ngoài ngành | 0988***123 |
| 3 | Người tham gia 3 | Nhân viên văn phòng | 0903***888 |
| 4 | Người tham gia 4 | Khách hàng tự do | 0971***456 |
| 5 | Người tham gia 5 | Sinh viên | 0932***789 |
| 6 | Người tham gia 6 | Người dùng di động | 0918***321 |
| 7 | Người tham gia 7 | Khách hàng tự do | 0909***654 |

### 5.3 Kết quả đánh giá Thang điểm Usability (SUS / UEQ-S Score)
- **Điểm SUS trung bình**: `[Điền điểm SUS ở đây]`
- **Nhận xét chính**: `[Điền tổng hợp phản hồi người dùng ở đây]`
