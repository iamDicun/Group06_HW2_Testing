...
**Mã kịch bản / Định danh**: `23127391_Stress_20260815`  
**Hệ thống mục tiêu**: EShop E-Commerce Backend (`http://localhost:3000`)  
**Loại kiểm thử**: Stress & Degradation Point Testing  
**Hình thức Báo cáo (Listener Type 2)**: Summary Aggregated JSON Metric Export (`reports/23127391_Stress_20260815_Summary.json`)  
...
**Báo cáo đầu ra**:
- File JSON Tổng hợp Chi tiết: `reports/23127391_Stress_20260815_Summary.json` chứa đầy đủ thông số p90, p95, max latency, throughput RPS và error rates.
