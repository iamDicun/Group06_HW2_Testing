...
## Bugs Found (5 SUT Bugs)

| Bug | Title | Severity | Screenshot |
|-----|-------|----------|------------|
| BUG-001 | Homepage renders 2 `<h1>` tags (FR-05/FR-21) | Medium | `Bug_01_GhubIssue.png` |
| BUG-002 | Price shows "VND" not "₫" (FR-05/FR-21) | Medium | `Bug_02_GhubIssue.png` |
| BUG-003 | Product images have empty `alt=""` (FR-05/FR-24) | Medium | `Bug03_GhIssue.png` |
| BUG-004 | XSS via `dangerouslySetInnerHTML` (SEC-04) | High | `Bug04_GhIssue.png` |
...
| 6 | Bug reports (≥3) | 10 | **10** | 5 bugs with screenshots & GitHub Issue format |
| 7 | Screenshot evidence | 10 | **10** | 30 test-result PNGs + 5 Bug Issue PNGs |
