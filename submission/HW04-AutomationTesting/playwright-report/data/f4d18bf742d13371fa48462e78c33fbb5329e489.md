...
- Name: FR-05.spec.ts >> FR-05: Xem danh sach & Tim kiem san pham >> FR05-TC002 - Trang chu chi co DUNG MOT the <h1> theo dac ta FR-05/FR-21
- Location: tests\FR-05.spec.ts:51:9

# Error details

```
Error: SUT co 2 the <h1>, dac ta FR-05/FR-21 chi cho phep 1 the
