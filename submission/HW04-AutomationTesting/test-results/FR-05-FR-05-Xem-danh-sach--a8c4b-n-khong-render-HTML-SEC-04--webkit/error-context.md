...
- Name: FR-05.spec.ts >> FR-05: Xem danh sach & Tim kiem san pham >> FR05-TC012 - Tu khoa tim kiem hien thi an toan, khong render HTML (SEC-04)
- Location: tests\FR-05.spec.ts:51:9

# Error details

```
Error: XSS: tim kiem '<b>test</b>' da render 1 the <b>, dac ta SEC-04 cam render HTML
  ...
  - main [ref=e10]:
    - generic [ref=e11]:
      - generic [ref=e12]:
        ...
        - generic [ref=e14]:
          - textbox "Tìm kiếm..." [ref=e15]: <b>test</b>
          - button "Tìm" [ref=e16] [cursor=pointer]
      - generic [ref=e17]:
        - text: "Kết quả tìm kiếm cho:"
        - generic [ref=e18]: test
  - contentinfo [ref=e19]: © 2026 EShop SUT. Dành cho mục đích kiểm thử.
```
