...
- banner:
  ...
  - navigation:
    - link "Giỏ hàng":
      - /url: /cart
    - link "Chào, User 1786324697069":
      - /url: /profile
    - button "Thoát"
- main:
  - heading "Hồ sơ của bạn" [level=2]
  - text: Email (Không đổi)
  - textbox [disabled]: user1786324697069@test.com
  - text: Họ Tên
  - textbox: User 1786324697069
  - text: Số điện thoại
  ...
  - table:
    ...
    - rowgroup:
      - row "#200 8/10/2026 500,000 ₫ Đã hủy":
        - cell "#200"
        - cell "8/10/2026"
        - cell "500,000 ₫"
        - cell "Đã hủy"
        - cell
      - row "#199 8/10/2026 500,000 ₫ Đã giao":
        - cell "#199"
        - cell "8/10/2026"
        - cell "500,000 ₫"
        - cell "Đã giao"
        - cell
      - row "#198 8/10/2026 500,000 ₫ Đang giao Hủy đơn":
        - cell "#198"
        - cell "8/10/2026"
        - cell "500,000 ₫"
        - cell "Đang giao"
        - cell "Hủy đơn":
          - button "Hủy đơn"
      - row "#197 8/10/2026 500,000 ₫ Đã xác nhận Hủy đơn":
        - cell "#197"
        - cell "8/10/2026"
        - cell "500,000 ₫"
        - cell "Đã xác nhận"
        - cell "Hủy đơn":
          - button "Hủy đơn"
      - row "#196 8/10/2026 500,000 ₫ Chờ xác nhận Hủy đơn":
        - cell "#196"
        - cell "8/10/2026"
        - cell "500,000 ₫"
        - cell "Chờ xác nhận"
