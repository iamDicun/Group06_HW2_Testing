...
- Name: FR-05.spec.ts >> FR-05: Xem danh sach & Tim kiem san pham >> FR05-TC018 - Trang KHONG duoc co nhieu hon 1 the <h1> (FR-05/FR-21)
- Location: tests\FR-05.spec.ts:51:9

# Error details

```
Error: SUT co 2 the <h1>, FR-05/FR-21 chi cho phep DUNG 1 the
