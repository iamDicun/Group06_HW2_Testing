...
- banner:
  ...
  - navigation:
    - link "Giỏ hàng":
      - /url: /cart
    - link "Chào, User 1786324891347":
      - /url: /profile
    - button "Thoát"
- main:
  - heading "Hồ sơ của bạn" [level=2]
  - text: Email (Không đổi)
  - textbox [disabled]: user1786324891347@test.com
  - text: Họ Tên
  - textbox: User 1786324891347
  - text: Số điện thoại
  ...
  - table:
    ...
    - rowgroup:
      - row "#246 8/10/2026 500,000 ₫ Đã hủy":
        - cell "#246"
        - cell "8/10/2026"
        - cell "500,000 ₫"
        - cell "Đã hủy"
        - cell
      - row "#245 8/10/2026 500,000 ₫ Đã giao":
        - cell "#245"
        - cell "8/10/2026"
        - cell "500,000 ₫"
        - cell "Đã giao"
        - cell
      - row "#244 8/10/2026 500,000 ₫ Đang giao Hủy đơn":
        - cell "#244"
        - cell "8/10/2026"
        - cell "500,000 ₫"
        - cell "Đang giao"
        - cell "Hủy đơn":
          - button "Hủy đơn"
      - row "#243 8/10/2026 500,000 ₫ Đã xác nhận Hủy đơn":
        - cell "#243"
        - cell "8/10/2026"
        - cell "500,000 ₫"
        - cell "Đã xác nhận"
        - cell "Hủy đơn":
          - button "Hủy đơn"
      - row "#242 8/10/2026 500,000 ₫ Chờ xác nhận Hủy đơn":
        - cell "#242"
        - cell "8/10/2026"
        - cell "500,000 ₫"
        - cell "Chờ xác nhận"
