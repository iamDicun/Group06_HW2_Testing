...
4. Người dùng có quyền hủy đơn hàng (User được phép hủy ở trạng thái `confirmed`).

## Các bước thực hiện

1. Người dùng đăng nhập vào hệ thống.
2. Người dùng truy cập **Lịch sử đơn hàng** hoặc **Admin Quản lý Đơn hàng**.
3. Người dùng tìm kiếm/chọn đơn hàng ở trạng thái `confirmed`.
...
- ✅ Trạng thái đơn hàng thay đổi từ `confirmed` → `canceled`.
...
- User được phép hủy đơn hàng khi nó đang ở trạng thái `confirmed`.
